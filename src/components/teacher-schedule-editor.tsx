      ...
      <Card>
        ...
        <CardContent className="space-y-4 px-4">
          <div className="space-y-2">
            ...
            <Textarea id="teachers-list" value={localTeachers} onChange={(e) => setLocalTeachers(e.target.value)} rows={3} placeholder="Enter one teacher per line..." />
          </div>
          ...
          <div className="space-y-2">
            ...
            <Textarea id="classes-list" value={localClasses} onChange={(e) => setLocalClasses(e.target.value)} rows={3} placeholder="Enter one class per line..." />
          </div>
          ...
          <div className="space-y-2">
            ...
            <Textarea id="subjects-list" value={localSubjects} onChange={(e) => setLocalSubjects(e.target.value)} rows={3} placeholder="Enter one subject per line..." />
          </div>
        </CardContent>
